...
public class ParserLoader 
{
	...
	private Map<String,Class<InputParser>> parserByMode = new HashMap<String,Class<InputParser>>();
	private Map<String,Class<InputParser>> parserBySuffix = new HashMap<String, Class<InputParser>>();
	private Map<String,String> helpByMode = new HashMap<String, String>();
    private Map<String,String> modeAndSuffix = new HashMap<String,String>();
	...
	public void load() 
	{
		try 
		{
	        ...
	        final String classlocation = URLDecoder.decode(url.getFile(), "UTF8");
